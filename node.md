...
- 见图片 [V8 引擎](./img/V8引擎1.png)
- 见图片 [V8 引擎](./img/V8引擎2.png)
- 见图片 [V8 引擎](./img/V8引擎3.png)
...
- Node 与浏览器架构的差异：见图片 [Chrome 与 Node 架构差异](./img/Chrome与Node架构的差异.png)
- Node 的详细架构：见图片 [Node 架构](./img/Node架构.png)
...
- json 数据轻量且易于 JS 对象进行转换，本质是有格式的字符串
- 格式：基本格式类似对象，属性用双引号，多个对象用[]括起来
- 方法：JSON.parse()将 JSON 字符串转成 JS 对象，JSON.stringify()将 JS 对象转成 JSON 字符串
